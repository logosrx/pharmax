...
// Compound-formula screening slice: the PV1-time product link and
// per-row ingredient coding.
export const COMPOUND_FORMULA_PRODUCT_NOT_FOUND = "COMPOUND_FORMULA_PRODUCT_NOT_FOUND";
export const COMPOUND_FORMULA_PRODUCT_NOT_COMPOUND = "COMPOUND_FORMULA_PRODUCT_NOT_COMPOUND";
export const COMPOUND_FORMULA_PRODUCT_ALREADY_CLAIMED = "COMPOUND_FORMULA_PRODUCT_ALREADY_CLAIMED";

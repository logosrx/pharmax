...
| HL7 FHIR R4 — `AllergyIntolerance`                                  | <https://hl7.org/fhir/R4/allergyintolerance.html>                                              | `category`, `type`, `criticality`, `verificationStatus` vocabulary for recorded allergies; drives which allergies are screened at PV1 and how severely they are graded.                    |
| HL7 FHIR R4 — `MedicationKnowledge`                                 | <https://hl7.org/fhir/R4/medicationknowledge.html>                                             | Shape of the drug-knowledge seam (`DrugKnowledgeSource`): a medication decomposes into ingredients and carries classification and dosing guidance.                                         |

...
## 3.1 When a signed artifact has to change

It happens. A defect is found after signature, or a fact changes. The rule
is that the **ledger is appended to, never edited**:

- Correct the artifact by **addition** — a dated amendment section the
  signer initials. Do not rewrite the body to read correctly. A correction
  that cannot be seen is not a correction, and a signed document that
  quietly agrees with its critics is worth nothing.
- Add a **new row** with the new digest, naming the amendment and what it
  changed.
- Mark the old row **superseded**. Do not delete it. That digest is what
  the reviewer actually signed, and removing it erases the only evidence
  that the document changed at all.

The mismatch between the two digests is not an embarrassment to tidy
away — it is the ledger working. An integrity record that can be edited
to agree with its subject proves nothing about either.

First exercised 2026-08-21 on the 2026-Q3 access review.
...
| ------------- | ----------------------------------------------------------- | ------------------------------------------------------------------ | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-19    | `evidence/access-reviews/2026-Q3/worksheet.md`              | `c5c1691a5c6968bdd2da6a0b4943d3cd898b03f41a37b442ef1050e8702bcde6` | Italo Pignano, CTO, 2026-08-19               | First infrastructure access review. Application-RBAC half recorded as not-applicable — zero organizations existed in the period. **SUPERSEDED 2026-08-21 by Amendment 1 — see the row below. Retained deliberately: this digest is what the reviewer signed on 2026-08-19, and deleting it would erase the evidence that the document changed.**                                                                                                                                                                                                                                                         |
...
| 2026-08-21    | `evidence/access-reviews/2026-Q3/worksheet.md`              | `e1f0361c2f5fa297c9686342f3c37c5b288536e222b5f8b18ebf53123063a3f7` | Italo Pignano, CTO, 2026-08-21 (Amendment 1) | **Supersedes the 2026-08-19 row.** Amendment 1 corrects two defects found after signature by an independent audit: §5's training-completion item was ticked over an unfilled placeholder when no training has ever been completed, and the header still read "AWAITING SIGNATURE" while §8 was signed. Corrected by ADDITION — the body was not rewritten apart from two markers pointing at §9 — because silently editing a signed record to make it read correctly is the failure this ledger exists to detect. None of the 20 row decisions, 6 manual surfaces, or findings F-1 to F-5 are withdrawn. |
